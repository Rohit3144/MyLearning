...
*/
/* 
 guest@guest-VirtualBox:/media/sf_VM_SHARED/my_learning$ gcc -O3 volatile_with_optimization.c -o volatile_with_optimization -save-temps
 guest@guest-VirtualBox:/media/sf_VM_SHARED/my_learning$ ./volatile_with_optimization
 Initial value of local : 10
 Modified value of local: 10
 guest@guest-VirtualBox:/media/sf_VM_SHARED/my_learning$ ls -l volatile_with_optimization.s
-rwxrwx--- 1 root vboxsf 902 Dec 29 16:09 volatile_with_optimization.s
 */
